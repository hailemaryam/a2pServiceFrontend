      ...
      <form id="kc-form-login" action="${url.loginAction}" method="post">
        ...
        <div class="form-group">
          ...
          <div class="password-row">
            <input tabindex="2" id="password" name="password" class="form-control" type="password" autocomplete="off" required aria-invalid="<#if messagesPerField.existsError('password')>true</#if>" />
          </div>
