...
const Modal = ({
  ...
  return createPortal(
    <div className={`fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 ${disableBackdropBlur ? "" : "backdrop-blur-sm"} transition-opacity`} onClick={handleOverlayClick}>
      <div
        ref={modalRef}
