          ...
          <div className="bg-gray-50 dark:bg-gray-800/50 rounded-2xl p-6 sm:p-10 border border-gray-200 dark:border-gray-700 shadow-sm">
            ...
            <div className="mb-10">
              ...
              <input
                ...
                style={{
                  background: `linear-gradient(to right, #E57A38 0%, #E57A38 ${(((Number(smsCount) || minSms) - minSms) / (maxSms - minSms)) * 100
                    }%, #d1d5db ${(((Number(smsCount) || minSms) - minSms) / (maxSms - minSms)) * 100
                    }%, #d1d5db 100%)`,
                }}
              />
              <style>{`
